...
class App extends Component {
  ...
  searchFilter = item => {
    ...
    const filter = this.state.MovieList.filter(e => {
      return e.Title === item.target.innerText;
    });
  ...
  handleChange() {
    console.log(
      `https://www.omdbapi.com/?s=${this.myInput.value}&apikey=a3733e00`
    );
  ...
  render() {
    return (
      <div className={styles.App}>
        <Navbar
          searchData={this.state.MovieList}
          filterToggle={this.searchFilter}
        ...
        <section className={styles.controlling}>
          ...
          <Main searchData={this.state.MovieList} search={this.search} />
        </section>
      </div>
    );
  }
